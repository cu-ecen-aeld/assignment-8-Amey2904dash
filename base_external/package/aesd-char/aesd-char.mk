...
AESD_CHAR_VERSION = c642bc26ed7f90d3df73a95a22a99d6a6cabbf4a #commit version number for A8 from A3 repo
# Note: Be sure to reference the *ssh* repository URL here (not https) to work properly
# with ssh keys and the automated build/test system.
# Your site should start with git@github.com:
AESD_CHAR_SITE = git@github.com:cu-ecen-aeld/assignments-3-and-later-Amey2904dash.git
